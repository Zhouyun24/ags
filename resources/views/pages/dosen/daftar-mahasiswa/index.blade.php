    ...
    <div class="px-5 pt-6">
        ...
        <div class="flex flex-col gap-4">
            @forelse ($mahasiswas as $mhs)
                <div x-show="cari === '' || '{{ strtolower($mhs->nim . ' ' . ($mhs->nama ?? '')) }}'.includes(cari.toLowerCase())" class="mb-4 rounded-xl border border-slate-100 bg-white p-4 shadow-[0px_4px_16px_0px_#0F172A14]">
