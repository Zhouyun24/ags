        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}"
                    placeholder="Masukkan Email Pengguna" required autofocus
            ...
            <div class="relative">
                ...
                <button type="button" @click="showPassword = !showPassword"
                    ...
                    <svg x-show="showPassword" x-cloak class="h-5 w-5" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="1.8">
                        <path d="M3 3l18 18" />
                        <path d="M10.6 5.1A10.9 10.9 0 0 1 12 5c7 0 10.5 7 10.5 7a15.5 15.5 0 0 1-3.4 4.3M6.6 6.6C3.7 8.4 1.5 12 1.5 12s3.5 7 10.5 7c1.4 0 2.6-.2 3.7-.6" />
