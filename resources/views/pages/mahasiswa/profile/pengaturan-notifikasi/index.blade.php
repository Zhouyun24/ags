...
@php
    $pengaturanAwal = [
        ...
        'jadwalDisetujui' => true,
        'jadwalDitolak' => false,
        'pengingatJadwal' => true,
        'hasilBimbingan' => true,
        'evaluasiBaru' => true,
    ...
    <form method="POST" action="" class="relative px-7 z-10">
        ...
        <div class="mb-5 rounded-2xl bg-white p-5 shadow-[0px_4px_16px_0px_#0F172A14]">
            ...
            <div class="divide-y divide-slate-100">
                <div class="flex items-center justify-between py-3">
                    <div>
                        <p class="font-inter text-sm font-medium text-black">Jadwal Disetujui</p>
                        <p class="font-inter text-xs text-slate-400">Dosen menyetujui permintaan bimbingan Anda</p>
                    </div>
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input type="checkbox" name="jadwal_disetujui" x-model="pengaturan.jadwalDisetujui" class="peer sr-only">
                        <div class="h-6 w-11 rounded-full bg-slate-200 transition-colors peer-checked:bg-[#2653EB]"></div>
                        <div class="absolute left-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-5"></div>
                    </label>
                </div>
                <div class="flex items-center justify-between py-3">
                    <div>
                        <p class="font-inter text-sm font-medium text-black">Jadwal Ditolak</p>
                        <p class="font-inter text-xs text-slate-400">Dosen menolak permintaan bimbingan Anda</p>
                    </div>
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input type="checkbox" name="jadwal_ditolak" x-model="pengaturan.jadwalDitolak" class="peer sr-only">
                        <div class="h-6 w-11 rounded-full bg-slate-200 transition-colors peer-checked:bg-[#2653EB]"></div>
                        <div class="absolute left-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-5"></div>
                    </label>
                </div>
                ...
                <div class="flex items-center justify-between py-3">
                    <div>
                        <p class="font-inter text-sm font-medium text-black">Hasil Bimbingan</p>
                        <p class="font-inter text-xs text-slate-400">Dosen menambahkan catatan bimbingan</p>
                    </div>
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input type="checkbox" name="hasil_bimbingan" x-model="pengaturan.hasilBimbingan" class="peer sr-only">
                        <div class="h-6 w-11 rounded-full bg-slate-200 transition-colors peer-checked:bg-[#2653EB]"></div>
                        <div class="absolute left-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-5"></div>
                    </label>
                </div>
                <div class="flex items-center justify-between py-3">
                    <div>
                        <p class="font-inter text-sm font-medium text-black">Evaluasi Baru</p>
                        <p class="font-inter text-xs text-slate-400">Hasil evaluasi akademik tersedia</p>
                    </div>
                    <label class="relative inline-flex shrink-0 cursor-pointer items-center">
                        <input type="checkbox" name="evaluasi_baru" x-model="pengaturan.evaluasiBaru" class="peer sr-only">
                        <div class="h-6 w-11 rounded-full bg-slate-200 transition-colors peer-checked:bg-[#2653EB]"></div>
                        <div class="absolute left-1 h-4 w-4 rounded-full bg-white transition-transform peer-checked:translate-x-5"></div>
                    </label>
                </div>
