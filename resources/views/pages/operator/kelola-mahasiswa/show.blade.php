...
<div class="pb-5">
    ...
    <div class="px-5 pt-6">
        <div class="mb-6 flex items-center gap-3 rounded-xl border border-[#DDD6FE] bg-[#EDE9FE]/50 p-4">
            ...
            <div>
                <p class="font-jakarta text-base font-extrabold text-black">{{ $mahasiswa->pengguna?->nama }}</p>
        ...
        <div class="mb-6 flex flex-col divide-y divide-slate-100 rounded-2xl bg-white p-5 shadow-[0px_4px_16px_0px_#0F172A14]">
            ...
            <div class="py-3 first:pt-0">
                ...
                <p class="mt-1 font-inter text-sm font-semibold text-black">{{ $mahasiswa->pengguna?->nama }}</p>
            </div>
            <div class="py-3">
                <p class="font-inter text-xs text-slate-500">Email</p>
                <p class="mt-1 font-inter text-sm font-semibold text-black">{{ $mahasiswa->pengguna?->email }}</p>
            </div>
            <div class="py-3">
                <p class="font-inter text-xs text-slate-500">Nomor Telepon</p>
                <p class="mt-1 font-inter text-sm font-semibold text-black">{{ $mahasiswa->pengguna?->nomor_telepon ?? '-' }}</p>
            </div>
            <div class="py-3">
        ...
        <div class="mb-6 grid grid-cols-2 gap-3">
            ...
            <a href="{{ route('operator.kelola-mahasiswa.edit', $mahasiswa->nim) }}"
