...
<div class="pb-5">
    <div class="relative overflow-hidden rounded-b-[20px] bg-gradient-to-br from-[#8B5CF6] via-[#7C3AED] to-[#6D28D9] px-5 pb-6 pt-5">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-jakarta text-xl font-extrabold text-white">Detail Operator</h1>
                <p class="mt-1 font-inter text-xs text-white">Informasi lengkap data operator</p>
            </div>
        </div>
    </div>
    ...
    <div class="px-5 pt-6">
        ...
        <div class="mb-6 flex flex-col divide-y divide-slate-100 rounded-2xl bg-white p-5 shadow-[0px_4px_16px_0px_#0F172A14]">
            <div class="py-3 first:pt-0">
                <p class="font-inter text-xs text-slate-500">ID Operator</p>
                <p class="mt-1 font-inter text-sm font-semibold text-black">{{ $operator->id_operator }}</p>
            </div>
            <div class="py-3 first:pt-0">
