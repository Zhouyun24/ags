...
<div x-data="{ showLogoutConfirm: false }" class="pb-8">
    ...
    <div class="relative px-7 z-10">
        ...
        <div class="-mt-12 mb-5 flex flex-col items-center rounded-2xl bg-white p-6 shadow-[0px_4px_16px_0px_#0F172A14]">
            <div class="relative">
                <div class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-[#8B5CF6] ring-4 ring-blue-100">
                    @if ($user->foto)
                ...
                <label for="upload-foto"
                    class="absolute -bottom-1 -right-1 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-[#8B5CF6] ring-2 ring-white hover:bg-blue-700">
        ...
        <div class="mb-5 rounded-2xl bg-white p-5 shadow-[0px_4px_16px_0px_#0F172A14]">
            ...
            <div class="divide-y divide-slate-100">
                ...
                <div class="flex items-center justify-between py-3">
                    <span class="font-inter text-xs text-slate-400">ID Operator</span>
                    <span class="font-inter text-xs font-medium text-black">{{ $user->id_operator }}</span>
                </div>
            </div>
        </div>
