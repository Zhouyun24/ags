...
<div x-data="{
    ...
    <form action="" method="POST" class="relative px-7 z-10">
        @csrf
        @method('PUT')
            ...
            <div class="mt-4 divide-y divide-slate-100">
                <div class="flex items-center justify-between py-4">
                    ...
                    <button type="button" role="switch" :aria-checked="settings.autentikasi_2fa"
                        ...
                        <span :class="settings.autentikasi_2fa ? 'translate-x-5' : 'translate-x-0'"
                            class="absolute left-1 top-1 h-4 w-4 rounded-full bg-white shadow transition-transform"></span>
                    </button>
                ...
                <div class="flex items-center justify-between py-4">
                    ...
                    <button type="button" role="switch" :aria-checked="settings.login_biometrik"
                        ...
                        class="relative h-6 w-11 shrink-0 rounded-full transition-colors">
                        <span :class="settings.login_biometrik ? 'translate-x-5' : 'translate-x-0'"
                            class="absolute left-1 top-1 h-4 w-4 rounded-full bg-white shadow transition-transform"></span>
                    </button>
                ...
                <div class="flex items-center justify-between py-4">
                    ...
                    <button type="button" role="switch" :aria-checked="settings.logout_otomatis"
                        ...
                        class="relative h-6 w-11 shrink-0 rounded-full transition-colors">
                        <span :class="settings.logout_otomatis ? 'translate-x-5' : 'translate-x-0'"
                            class="absolute left-1 top-1 h-4 w-4 rounded-full bg-white shadow transition-transform"></span>
                    </button>
